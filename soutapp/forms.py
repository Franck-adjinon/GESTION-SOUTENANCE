...
class UpdateUserInfo(forms.Form):
    nom_user = forms.CharField(label='Nouveau Nom', max_length=50, widget=forms.TextInput(attrs={
        'autofocus': True,
    ...
    prenom_user = forms.CharField(label='Nouveau Prénom', max_length=50, widget=forms.TextInput(attrs={
        'class': 'shadow-sm py-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md',
        'placeholder': '',
        'id': 'first-name',
        'name' : 'first-name',
    ...
    email = forms.EmailField(label='Nouvelle Adresse mail', max_length=100, widget=forms.EmailInput(attrs={
        'class': 'shadow-sm py-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md',
        'placeholder': '',
        'id': 'email',
        'name' : 'email',
    ...
    password = forms.CharField(label='Nouveau Mots de passe', max_length=255, widget=forms.PasswordInput(attrs={
        'class': 'shadow-sm py-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md',
        'placeholder': '',
        'id': 'email',
        'name' : 'email',
